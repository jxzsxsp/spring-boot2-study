...
package cn.xiaoshuiping.websocket.undertow.echo;

import java.util.concurrent.CountDownLatch;
import java.util.concurrent.TimeUnit;
import java.util.concurrent.atomic.AtomicReference;

import cn.xiaoshuiping.websocket.undertow.SampleUndertowWebSocketsApplication;
import cn.xiaoshuiping.websocket.undertow.client.GreetingService;
import cn.xiaoshuiping.websocket.undertow.client.SimpleClientWebSocketHandler;
...
@SpringBootTest(classes = { SampleUndertowWebSocketsApplication.class,
		CustomContainerWebSocketsApplicationTests.CustomContainerConfiguration.class }, webEnvironment = WebEnvironment.RANDOM_PORT)
